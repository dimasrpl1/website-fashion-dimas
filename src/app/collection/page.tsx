...
export default function CollectionPage() {
  ...
  return (
    <div className="min-h-screen font-[family-name:var(--font-geist-sans)] text-black bg-white">
      ...
      <div className="w-full">
        <div className=" max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-6 mb-2">
          <nav className="flex items-center space-x-2 text-sm font-light text-gray-600">
            ...
            <span className="hover:text-gray-800 transition-colors uppercase tracking-wide cursor-default">
              Collection
            </span>
          </nav>
        </div>
      ...
      <section className="bg-white/80 w-full px-4 sm:px-6 lg:px-8 xl:px-12 pt-6 sm:pt-8 lg:pt-10 pb-6 sm:pb-8 lg:pb-10 bg-transparent">
  ...
  const CardContent = (
    ...
    >
      <div className="relative w-full h-80 sm:h-96 lg:h-[400px] xl:h-[450px] overflow-hidden">
        ...
        {/* Hover overlay for available product */}
        {product.status && (
