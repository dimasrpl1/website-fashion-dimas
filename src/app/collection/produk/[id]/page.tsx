...
export default function ProdukDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <div className="min-h-screen bg-white font-[family-name:var(--font-geist-sans)]">
      ...
      {/* Breadcrumb - Hidden on mobile, langsung menempel di bawah navbar untuk desktop */}
      ...
      {/* Product Details - Adjusted padding for mobile/desktop */}
      <main className="w-full">
        <div className="max-w-7xl mx-auto px-6 lg:px-8 pt-20 lg:pt-12 pb-8 lg:pb-12">
